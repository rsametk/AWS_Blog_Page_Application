...
DATABASES = {
    'default': {
        ...
        'HOST': 'database-1.c9yazexbemop.us-east-1.rds.amazonaws.com',  # database endpoint is written here
...
AWS_STORAGE_BUCKET_NAME = 'capstone.rsametk.com' # please enter your s3 bucket name
